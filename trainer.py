...
if args.resume:
    ...
    print("last train epoch[%2d] value acc[%2.3f] equation acc[%2.3f]" %
          (start_epoch, best_value_acc, best_equ_acc))
else:
    start_epoch = 0
    best_value_acc = 0
    best_equ_acc = 0
...
for epo in range(start_epoch, args.epochs_num):
    ...
    print(
        ...
        % (epo+1, args.epochs_num, loss_total / batch_nums,
           equation_ac / eval_total, value_ac / eval_total))
    print("---------------------------------------------")
print("training finished,best value acc:{} equation acc:{}".format(
    best_value_acc, best_equ_acc))
